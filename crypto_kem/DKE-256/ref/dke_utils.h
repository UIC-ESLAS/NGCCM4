...
/// @brief Computes the DKEM-256 signal function for the polynomial k using coins as randomness
...
/// @brief Reconciliation function of DKEM-256. Derives ss from poly k and signal sig.
