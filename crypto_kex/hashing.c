...
static const unsigned char hashing_seed[] = {
    ...
    0x65, 0x78, 0x2d, 0x68, 0x61, 0x73, 0x68, 0x69,
...
static void reset_hash_profile(void)
{
    hash_cycles = 0;
    func_cycles = 0;
}

static void send_hash_profile(const char *hash_label, const char *func_label)
{
    send_unsignedll(hash_label, hash_cycles);
    send_unsignedll(func_label, func_cycles);
}
...
int main(void)
{
    ...
    for (i = 0; i < NGCC_ITERATIONS; i++) {
        ...
        send_hash_profile("init_a hash cycles:", "init_a func cycles:");
        ...
        send_hash_profile("init_b hash cycles:", "init_b func cycles:");
        ...
        send_hash_profile("pass1 hash cycles:", "pass1 func cycles:");
        ...
        send_hash_profile("pass2 hash cycles:", "pass2 func cycles:");
        ma = m1;
        ma_len = m1_len;
        if (pass == 3) {
            reset_hash_profile();
            ...
            send_hash_profile("pass3 hash cycles:", "pass3 func cycles:");
            ma = m3;
            ma_len = m3_len;
        }
        ...
        send_hash_profile("derive_a hash cycles:", "derive_a func cycles:");
        ...
        send_hash_profile("derive_b hash cycles:", "derive_b func cycles:");
